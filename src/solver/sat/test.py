...
if __name__ == "__main__":
    ...
    parser.add_argument("--conflicts_limit", default=1000000000, help="The initial limit on the number of conflicts before "
                                                               "the CDCL solver restarts")
    parser.add_argument("--lbd_limit", default=100000000, help="The initial limit on the number of different decision levels "
